...
public class Main
{
	...
	public static <T extends Agrupacion<Integer>> void anyadir_elementos(T ag)
	{
		ag.anyadir(42);
		ag.anyadir(15);
		ag.borrarUltimo();
	...
	public static <T extends Iterable<Integer> & Agrupacion<Integer>> void mostrar_elementos(T ag)
	{
		for (Integer i : ag)
			System.out.print(i+" ");
		System.out.println();
