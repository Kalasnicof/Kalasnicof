...
private:
	...
	Node* head;//Puntero a la cabecera que sera el ultimo añadido

public:
//	Ahora la funcion iniciar de la estructura es el constructor.
	agrupacion_dinamica(): head(0)
    ...
    {
		//Declaras el primer elemento de la agrupacion como nullptr
...
//	TODO: La funcion borrarUltimo se transforma tambien en un metodo. Rellénalo.
	...
	public:
		...
		const_iterator(const agrupacion_dinamica& c_, Node* i_) : i(i_), c(c_) {  }
